...
ax_3d_1.view_init(elev=10, azim=-40)  # Ustawienie początkowego kąta widzenia
...
# Ustawienie początkowej pozycji widoku
ax_3d_2.view_init(elev=0, azim=0)  # Ustawienie początkowego kąta widzenia
...
# Zapisz animację
ani_3d.save('rotating plot.gif', dpi=120, writer='pillow', fps=20)
...
gbest_plot = ax.scatter([gbest[0]], [gbest[1]], marker='*', s=200, color='black', alpha=0.5)
ax.set_xlim([0, 5])
ax.set_ylim([0, 5])
...
anim_pso.save("pso 2d.gif", dpi=120, writer="pillow")
